								...
								<td align="left" valign="top">
									<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
										...
										<div style="float:right; width:15px; height:25px;margin-top:10px"><img id="return_btn" onclick="reload_Soft_Center();" align="right" style="cursor:pointer;position:absolute;margin-left:-30px;margin-top:-25px;" title="返回软件中心" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'"></img></div>
                                                ...
                                                <li>使用前需要将域名添加到dnspod中，并添加要自动更新的A或AAAA记录，使用之后将自动更新ip</li>
                                                <li>Token格式为：ID,Token 注意是英文逗号！注意是6位数字ID和Token，不是SecretID和Key。</li>
										...
										<tr>
										<th width="35%">IPv6 子域名</th>
										<td>
										<input type="text" class="input_ss_table" style="width:auto;" size="30" id="ddnspod_config_uname" name="ddnspod_config_uname" maxlength="50" placeholder="类似：ipv6" value='<% dbus_get_def("ddnspod_config_uname", ""); %>' >
										<div class="formfontdesc" style="margin-left:270px;margin-top:-20px;margin-bottom:0px;color:rgb(255,204,0);">只填子域名</div>
                                        </td>
										</tr>
										<tr>
										...
										<div class="formfontdesc" style="margin-left:270px;margin-top:-20px;margin-bottom:0px;color:rgb(255,204,0);">id,Token</div>
										</td>
										</tr>
										<tr>
										<th width="35%">填写主域名</th>
										<td>
										<input type="text" class="input_ss_table" style="width:auto;" size="30" id="ddnspod_config_domain" name="ddnspod_config_domain" maxlength="40" placeholder="类似：baidu.com" value='<% dbus_get_def("ddnspod_config_domain", ""); %>' >
										</td>
										</tr>
